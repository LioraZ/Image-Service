...
namespace ImageService
{
    ...
    public partial class ImageService : ServiceBase
    {
        ...
        protected override void OnStop() { eventLog.WriteEntry("In onStop."); }

        protected override void OnContinue() { eventLog.WriteEntry("In OnContinue."); }
